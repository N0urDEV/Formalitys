          ...
          <div className="rounded-2xl border border-[#00171f]/20 bg-[#00171f]/5 p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[#00171f]/80 text-sm" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                  Réduction dégressive dès la <span className="font-semibold">2ème création de société</span> ou le <span className="font-semibold">2ème hébergement touristique</span>. Contactez-nous pour en profiter.
                </p>
              </div>
            </div>
          </div>
