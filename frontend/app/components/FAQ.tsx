...
export default function FAQ() {
  ...
  // Show only top 4 FAQs initially, or all if showAllFAQs is true
                    ...
                    <div className="px-6 lg:px-8 pb-6 lg:pb-8">
                      <div className="ml-16">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                          <p className="text-sm text-gray-600 mb-3" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                            Besoin d'aide personnalisée ?
                          </p>
                          <div className="flex flex-col sm:flex-row gap-2">
                            <a
                              href="https://wa.me/212620269000?text=Bonjour, j'ai une question sur la création de société"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center justify-center bg-[#25D366] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#128C7E] transition-colors duration-200"
                              style={{ fontFamily: 'Satoshi, sans-serif' }}
                            >
                            ...
                            <a
                              ...
                              className="inline-flex items-center justify-center border border-[#007ea7] text-[#007ea7] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#007ea7] hover:text-white transition-colors duration-200"
                              style={{ fontFamily: 'Satoshi, sans-serif' }}
                            >
          ...
          {filteredFAQs.length > 4 && (
            <div className="text-center mt-8">
              <button
                ...
                className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-2xl font-semibold hover:bg-white/30 transition-all duration-300 border border-white/30"
                style={{ fontFamily: 'Satoshi, sans-serif' }}
              >
                <span>{showAllFAQs ? 'Voir moins' : `Voir toutes les questions (${filteredFAQs.length})`}</span>
                <svg 
