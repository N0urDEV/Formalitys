                    ...
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-[#00171f] font-semibold" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                          {formatAmount(dossier.finalPrice || dossier.amountPaid)}
                        </span>
                      </div>
                      {dossier.discountApplied && dossier.discountApplied > 0 && (
                        <div className="text-xs text-green-600 ml-6" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                          -{formatAmount(dossier.discountApplied)} ({dossier.discountReason?.replace('loyalty_tier_', '')}%)
                        </div>
                      )}
                      {dossier.originalPrice && dossier.originalPrice !== (dossier.finalPrice || dossier.amountPaid) && (
                        <div className="text-xs text-gray-500 line-through ml-6" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                          {formatAmount(dossier.originalPrice)}
                        </div>
                      )}
                    </div>
                  </td>
